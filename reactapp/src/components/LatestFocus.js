        ...
        if (this.state.isLoading === false) {
            ...
            return (
                <div className="bodyDiv">
                    ...
                    <h3 style={{ paddingTop: "25px", textAlign: "center", paddingBottom: "25px" }}><a href={urlList[urlList.length - 2]} target={"_blank"} className="glow" style={{ fontSize: "50px" }}>{titleList[titleList.length - 2]}</a></h3>
