        ...
        return (
            <div>
                ...
                <ol className="list-medium">
                    <Link to="/heart_of_algebra/about" style={{ color: "#365789" }}><li style={{ paddingTop: "20px" }} id='link1' onClick={this.visitedLink("link1")}><strong>A little bit about Heart of Algebra</strong></li></Link>
