        ...
        return (
            <div style={{ paddingBotton: "25px" }}>
                ...
                <ol className="list-medium">
                    ...
                    <li><Link to="passport_to_advanced_math/polynomials_of_higher_degree" style={{ color: "#365789" }} onMouseOver={this.changeLinkColorEnter} onMouseOut={this.changeLinkColorLeave}>Quadratic Inequalities</Link></li>
