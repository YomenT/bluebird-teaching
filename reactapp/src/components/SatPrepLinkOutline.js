        ...
        return (
            <div style={{ paddingBotton: "25px" }}>
                ...
                <ol className="list-medium">
                    <li style={{ paddingTop: "20px" }} onMouseEnter={this.changeLinkColorEnter} onMouseLeave={this.changeLinkColorLeave}><Link to="/heart_of_algebra/about" style={{ color: "#365789" }}><strong>A little bit about Heart of Algebra</strong></Link></li>
